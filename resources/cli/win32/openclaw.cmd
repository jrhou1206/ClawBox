...
if /i "%1"=="update" (
    echo openclaw is managed by ClawBox ^(bundled version^).
    echo.
    echo To update openclaw, update ClawBox:
    echo   Open ClawBox ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=ClawBox
"%~dp0..\..\ClawBox.exe" "%~dp0..\openclaw\openclaw.mjs" %*
