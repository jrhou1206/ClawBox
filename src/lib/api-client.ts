...
const GATEWAY_WS_DIAG_FLAG = 'clawbox:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('clawbox:api-log') === '1';
  } catch {
